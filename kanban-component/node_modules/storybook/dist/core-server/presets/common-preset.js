...
import {
  getLastEvents,
  getSessionId
} from "../../_node-chunks/chunk-Z4E4GMT4.js";
import {
  invariant
...
import "../../_node-chunks/chunk-KBHZ3GEC.js";
import {
  loadConfig
} from "../../_node-chunks/chunk-3VZU4AAT.js";
import {
  require_dist
...
var getComponentVariableName = /* @__PURE__ */ __name(async (name) => {
  const camelCase = await import("../../_node-chunks/camelcase-KA7E7LOC.js");
...
async function searchFiles({
  ...
  const { globby, isDynamicPattern } = await import("../../_node-chunks/globby-C6VT7FAK.js");
...
var favicon = /* @__PURE__ */ __name(async (value, options) => {
  ...
  const faviconPaths = statics.map((dir) => {
    ...
    if (targetEndpoint === "/") {
      results.push(join5(staticPath, "favicon.svg"));
      results.push(join5(staticPath, "favicon.ico"));
    }
...
var managerHead = /* @__PURE__ */ __name(async (_, options) => {
  const location = join5(options.configDir, "manager-head.html");
...
var viteFinal = /* @__PURE__ */ __name(async (existing, options) => {
  ...
  const { viteInjectMockerRuntime } = await import("../../_node-chunks/plugin-TTZELBHN.js");
  const { viteMockPlugin } = await import("../../_node-chunks/plugin-VBK5MDIY.js");
  const coreOptions = await options.presets.apply("core");
  return {
    ...existing,
    plugins: [
...
var webpackFinal = /* @__PURE__ */ __name(async (config, options) => {
  ...
  const { WebpackMockPlugin } = await import("../../_node-chunks/webpack-mock-plugin-RGGBGU33.js");
  const { WebpackInjectMockerRuntimePlugin } = await import("../../_node-chunks/webpack-inject-mocker-runtime-plugin-PSO63NLP.js");
